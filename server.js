...
client.on("ready", async () => {
  client.user.setPresence({ activity: { name: "CANLI DEŞTEK İCİN DM" } });
...
client.on("message", async message => {
  ...
  if (message.content.startsWith("!eval") && message.author.id === ayarlar.botOwner) {
  ...
  if (message.channel.type === "dm" && (koruma == null || koruma == undefined || koruma == false)) {
    ...
    client.channels.cache.get(ayarlar.logChannelID).send(embed);
